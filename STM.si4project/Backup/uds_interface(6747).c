...
uint8 EcuApplicationSoftwareVersionNumber[6]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF};//F1A0  {ASCLL,ASCLL,BCD,ASCLL,BCD,BCD}  only read
...
uint8 CalibrationDataIdentifier[14]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF};//F1A4  {BCD,BCD,BCD}  read & write
...
{
	return dtc_status[index].all & 0x000ff;
}
