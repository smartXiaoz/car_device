...
uint8 vin[17]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; //read & write
uint8 Software_Reference_Number[10]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF};//F183 only read
uint8 EcuPartNumber[6]={0x43,0x00,0x14,0x31,0x16,0x00};//F187 {ASCLL,BCD,BCD,BCD,BCD,BCD}  only read   C 00 14 31 16 
uint8 SystemSupplierID[6]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF};//F18A {ASCLL,BCD,BCD,BCD,BCD,BCD}  only read
uint8 EcuHardwareVersionNumber[6]={0x48,0x56,0x01,0x2E,0x02,0x01};//F191  {ASCLL,ASCLL,BCD,ASCLL,BCD,BCD}  only read HV1.02
uint8 EcuApplicationSoftwareVersionNumber[6]={"NV1.12"};//{0x4E,0x56,0x01,0x2E,0x01,0x02};//F1A0  {ASCLL,ASCLL,BCD,ASCLL,BCD,BCD}  only read  NV1.12
