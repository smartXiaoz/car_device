...
//--------------------------		NTSC		------------------------------//
//=================================================================================
//08 ×Ô¶¯	c8 NTSC-M  D8 NTSC-4.43  E8 NTSC-N
const unsigned char	tbl_ntsc_pg0_cmn[] = {        
//												CH1			CH2			CH3			CH4
	0x00,0x08,0x20,0xd0,		//...		0x00~0x03	0x10~0x13	0x20~0x23	0x30~0x33
	0x06,0xf0,0x08,0x80,		//...		0x04~0x07	0x14~0x17	0x24~0x27	0x34~0x37
	0x80,0x30,0x70,0x02,		//...		0x08~0x0b	0x18~0x1b	0x28~0x2b	0x38~0x3b
	0x06,0x00,0x11				//...		0x0c~0x0e	0x1c~0x1e	0x2c~0x2e	0x3c~0x3e
};

const unsigned char	tbl_ntsc_pg0_sfr1[] = {		//... other decoder part
...
//	0x00,0x7f,0x7f,0x45,		//...		0x40~0x43	//... update:060315
	...
	0xa0,0xD0,0x2f,0x64,		//...		0x44~0x47	0X45 = D0->00  0X46=2F->1F
	0x80,0x80,0x82,0x80,		//...		0x48~0x4b	0X4A&0X4B = 82->80
	0x30,0x0f,0x05,0x00,		//...		0x4c~0x4f
	0x00,0x80,0x06,0x00,		//...		0x50~0x53
	0x00							//...		0x54
};

const unsigned char	tbl_ntsc_pg0_sfr2[] = {		//... audio part
...
const unsigned char	tbl_ntsc_pg0_scl[] = {
//												CH1			CH2			CH3			CH4
...
const unsigned char	tbl_ntsc_pg0_sfr3[] = {		//... 
...
//--------------------------		PAL		------------------------------//
//=================================================================================
const unsigned char	tbl_pal_pg0_cmn[] = {        
//												CH1			CH2			CH3			CH4
...
const unsigned char	tbl_pal_pg0_sfr1[] = {		//... other decoder part
//	0x00,0x00,0x7f,0x45,		//...		0x40~0x43	//... before 060315
//	0x00,0x7f,0x7f,0x45,		//...		0x40~0x43	//... update:060315
...
const unsigned char	tbl_pal_pg0_sfr2[] = {		//... audio part
...
const unsigned char	tbl_pal_pg0_scl[] = {
//												CH1			CH2			CH3			CH4
	0x01,0x7f,0xff,0x7f,		//...		0x80~0x83	0x90~0x93	0xa0~0xa3	0xb0~0xb3
	0xff,0x00,0xff,0xff,		//...		0x84~0x87	0x94~0x97	0xa4~0xa7	0xb4~0xb7
	0xff,0xff,0x31,0x00,		//...		0x88~0x8b	0x98~0x9b	0xa8~0xab	0xb8~0xbb
...
const unsigned char	tbl_pal_pg0_sfr3[] = {		//... 
	0x00,0x00,0x00,0x07,		//...		0xc0~0xc3
...
//==================================================================================
const unsigned char	tbl_pg1_x_cmn[] = {
...
const unsigned char	tbl_pg1_y_cmn[] = {
//  00   01   02   03   04   05   06   07		 08   09   0A   0B   0C   0D   0E   0F
...
//--------------------------		NTSC		------------------------------//
//=================================================================================
const unsigned char	tbl_ntsc_pg1_enc[] = {
//  00   01   02   03   04   05   06   07		 08   09   0A   0B   0C   0D   0E   0F
	0x77,0x23,0x90,0x01,0x80,0x20,0x00,0x0c,	0x20,0x09,0xaa,0x00,0x40,0x40,0x00,0x00	//... 0xa0
//	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00	//... 0xb0
};
//--------------------------		PAL		------------------------------//
//=================================================================================
const unsigned char	tbl_pal_pg1_enc[] = {
//  00   01   02   03   04   05   06   07		 08   09   0A   0B   0C   0D   0E   0F
...
//--------------------------		PAGE 2		------------------------------//
const unsigned char	tbl_pg2_mse_box[] = {		// 80 EA
//  00   01   02   03   04   05   06   07		 08   09   0A   0B   0C   0D   0E   0F
	//... mouse & LUT
...
const unsigned char	tbl_ntsc_pg2_2dbox[] = {		// 32 EA
	//... 2d array box
...
const unsigned char	tbl_ntsc_pg2_mtn[] = {		// 32 EA
...
const unsigned char	tbl_pal_pg2_2dbox[] = {		// 32 EA
	//... 2d array box
...
const unsigned char	tbl_pal_pg2_mtn[] = {		// 32 EA
	//... sensitivity & mask info
	0x17,0x73,0x88,0x4a,0x07,0x24,0x00,0x00,	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,	//...  0x80
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00	//...  0x90
//	0x17,0x73,0x88,0x4a,0x07,0x24,0x00,0x00,	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,	//...  0xa0
